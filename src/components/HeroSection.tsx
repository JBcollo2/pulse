          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-start">
              <button
                ...
                className={cn(
                  "bg-gradient-to-r from-blue-500 to-green-500 hover:from-blue-600 hover:to-green-600 text-white font-medium shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 rounded-lg md:rounded-xl px-4 md:px-6 lg:px-7 py-2 md:py-3 lg:py-3.5 text-sm md:text-base flex items-center justify-center gap-1.5 group border border-white/20"
                )}
              >
