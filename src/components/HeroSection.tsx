      ...
      <div className="relative overflow-hidden w-full bg-gradient-to-br from-gray-900 via-blue-900 to-green-900 min-h-[500px]">
        ...
        <div className="absolute top-3 right-3 md:top-4 md:right-4 z-20 flex items-center gap-1.5">
          <button
            ...
            className="w-7 h-7 md:w-8 md:h-8 bg-black/30 backdrop-blur-sm border border-white/30 text-white hover:bg-black/40 rounded-full transition-all duration-200 flex items-center justify-center shadow-lg"
          ...
          >
            <ChevronRight className="w-3 h-3 md:w-3.5 md:h-3.5 rotate-180" />
          </button>
          ...
          <div className="flex-1 flex flex-col justify-center p-4 md:p-8 lg:p-12">
            <div className="w-full max-w-4xl">
              ...
              <div className="flex flex-wrap items-center gap-3 mb-4">
                <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-md border border-white/25 rounded-full px-4 py-2 text-white/90 text-sm font-medium">
                  {isLoadingEvents ? (
                    <>
                ...
                {slides[currentSlide] && !isLoadingEvents && (
                  <div className="inline-flex items-center gap-2 bg-green-500/20 backdrop-blur-md border border-green-400/30 rounded-full px-4 py-2 text-green-100 text-sm font-medium">
                ...
                {events.length === 0 && !isLoadingEvents && (
                  <div className="inline-flex items-center gap-2 bg-yellow-500/20 backdrop-blur-md border border-yellow-400/30 rounded-full px-4 py-2 text-yellow-100 text-sm font-medium">
                    Preview Mode
                  </div>
                )}
              </div>
              ...
              <div className="mb-6 max-w-lg">
                <form onSubmit={handleSearch} className="relative">
                  <input
                    ...
                    className="w-full pl-12 pr-20 py-3 rounded-2xl bg-white/15 backdrop-blur-md border-2 border-white/25 text-white placeholder-white/60 focus:bg-white/20 focus:border-white/50 focus:ring-2 focus:ring-white/20 transition-all duration-300 text-base focus:outline-none"
                  />
                  <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-white/70 h-4 w-4" />
                  <button
                    type="submit"
                    disabled={!searchQuery.trim()}
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-blue-500 to-green-500 hover:from-blue-600 hover:to-green-600 disabled:from-gray-500 disabled:to-gray-600 disabled:cursor-not-allowed text-white rounded-xl px-4 py-2 font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 text-sm"
                  >
                    Search
                  </button>
                </form>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  className="bg-gradient-to-r from-blue-500 to-green-500 hover:from-blue-600 hover:to-green-600 text-white font-medium shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 rounded-xl px-6 py-3 text-base flex items-center justify-center gap-2 group"
                >
