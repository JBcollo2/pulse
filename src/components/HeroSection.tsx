      ...
      <div className="relative overflow-hidden w-full h-screen min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-500">
            ...
            >
              <div
                ...
                style={{
                  ...
                  // Improved filters for better text contrast
              ...
              {/* Strong targeted overlay for text area */}
        ...
        <div className="relative z-10 flex flex-col h-full w-full px-3 md:px-4 lg:px-5">
          ...
          >
            ...
            {/* Enhanced Subtitle with Strong Text Shadow */}
            <p 
              className="text-white mb-5 md:mb-6 max-w-2xl leading-relaxed font-light text-sm sm:text-base md:text-lg lg:text-xl"
              style={{
                textShadow: '2px 2px 6px rgba(0,0,0,0.9), 0 0 12px rgba(0,0,0,0.7), 1px 1px 3px rgba(0,0,0,1)',
