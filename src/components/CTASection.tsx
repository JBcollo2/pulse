...
const CTASection = () => {
  ...
  return (
    <section className="relative py-20 px-4 bg-gradient-to-br from-gray-900 via-blue-900 to-green-900">
      <style>{`
        .navbar-backdrop {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="text-gray-100 dark:text-gray-100">Ready to</span>
              <br />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
            {[
              ...
              <div key={index} className="text-center p-6 bg-white/10 backdrop-blur-md dark:bg-gray-700/20 rounded-xl shadow-sm border border-white/20">
                <div className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-green-400 text-transparent bg-clip-text mb-2">
                  {stat.number}
                </div>
                <div className="text-gray-200 dark:text-gray-300 text-sm font-medium">
                  {stat.label}
                </div>
              </div>
            ))}
          ...
          {/* Main CTA Card */}
          <div className="bg-white/10 backdrop-blur-lg dark:bg-gray-700/20 rounded-3xl p-8 md:p-12 shadow-xl border border-white/20 dark:border-gray-600/30">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="hidden lg:block">
                <div className="aspect-w-16 aspect-h-9 w-full h-full rounded-2xl overflow-hidden bg-white/5 backdrop-blur-sm dark:bg-gray-800/20 flex items-center justify-center text-gray-300 dark:text-gray-400 border border-white/10">
