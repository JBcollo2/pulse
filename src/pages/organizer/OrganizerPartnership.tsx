                        ...
                        <Dialog open={isCollaborationDialogOpen} onOpenChange={handleCollaborationDialogClose}>
                          <DialogTrigger asChild>
                            <Button
                              ...
                              className="bg-gradient-to-r from-blue-500 to-[#10b981] hover:from-blue-500 hover:to-[#10b981] text-white text-xs sm:text-sm p-1 sm:p-2"
                            >
                              <Plus className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2" />
                              Add Collaboration
                            </Button>
                      ...
                      <CardContent className="pt-0">
                        <div className="space-y-3">
                          <p className="text-xs sm:text-sm dark:text-gray-300 text-gray-700">
                            Before adding a collaboration, ensure you have contacted the company or organization for approval. If you haven't created a partner profile yet, please create one first.
                          </p>
                        </div>
                      </CardContent>
                    </Card>
