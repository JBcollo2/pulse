...
const OrganizerDashboard: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 text-foreground flex">
            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="p-8 flex-1 min-h-[calc(100vh-12rem)] overflow-y-auto custom-scrollbar">
                    {error && (
