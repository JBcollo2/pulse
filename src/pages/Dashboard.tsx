...
const Overview = () => <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
  <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">Overview Dashboard</h2>
    ...
    <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm hover:shadow-md transition">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-3xl font-bold text-green-600 dark:text-green-400">1,429</p>
        </div>
        <Ticket className="h-8 w-8 text-green-500 dark:text-green-400" />
      </div>
    </div>
    <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm hover:shadow-md transition">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-3xl font-bold text-purple-600 dark:text-purple-400">$45,280</p>
        </div>
...
const Tickets = () => <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
  <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">Ticket Management</h2>
  <p className="text-gray-600 dark:text-gray-400">Manage and track all your event tickets here.</p>
</div>;

const QRScanner = () => <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
  <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">QR Code Scanner</h2>
  <p className="text-gray-600 dark:text-gray-400">Scan ticket QR codes for event entry.</p>
</div>;

const ManageOrganizersPage = () => <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
  <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">Organizer Management</h2>
  <p className="text-gray-600 dark:text-gray-400">Manage your team members and organizers.</p>
</div>;

const UserProfile = () => <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
  <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">User Profile</h2>
  <p className="text-gray-600 dark:text-gray-400">Update your account settings and preferences.</p>
</div>;

const Admin = () => <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-xl">
  <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">Admin Panel</h2>
  <p className="text-gray-600 dark:text-gray-400">System administration and advanced settings.</p>
</div>;

// Mock Navbar and Footer components
const Navbar = () => (
  <nav className="fixed top-0 left-0 right-0 h-16 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-gray-200 dark:border-gray-700 z-40">
    <div className="flex items-center justify-between px-6 h-full">
      ...
      <div className="hidden md:flex items-center space-x-4">
        <button className="px-4 py-2 text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 transition-colors">
          Help
        </button>
      ...
      <div className="flex items-center justify-between">
        {!sidebarCollapsed && (
          <div className="animate-fade-in">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage your events with ease</p>
          </div>
        )}
        <button
          onClick={() => setSidebarCollapsed(!sidebarCollapsed)}
        ...
        >
          {sidebarCollapsed ?
            <Menu className="h-5 w-5 text-gray-600 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-gray-100" /> :
            <X className="h-5 w-5 text-gray-600 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-gray-100" />
          }
        </button>
      </div>
        ...
        <div className="mt-4 relative animate-fade-in">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl
                     ...
                     transition-all duration-200 text-gray-700 dark:text-gray-300 placeholder-gray-400 dark:placeholder-gray-300"
          />
        </div>
      )}
    </div>
          ...
          <button
            ...
            className={`
              ...
              ${isActive
                ...
                : `hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 ${item.hoverColor}`
              }
            `}
            style={{
              animationDelay: `${index * 50}ms`
              ...
              <>
                ...
                <ChevronRight className={`
                  ...
                  ${isActive
                    ...
                    : "text-gray-400 dark:text-gray-300 opacity-0 group-hover:opacity-70"
                  }
                `} />
              </>
            )}
...
const ContentHeader = ({ activeMenuItem, sidebarCollapsed }) => (
  <div className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm border-b border-gray-100 dark:border-gray-700 px-8 py-6">
    <div className="flex items-center justify-between">
      ...
      {/* Breadcrumb */}
      <div className="hidden md:flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 px-4 py-2 rounded-full">
        <span>Dashboard</span>
        <ChevronRight className="h-4 w-4" />
        <span className="text-gray-900 dark:text-gray-100 font-medium">{activeMenuItem?.name}</span>
      </div>
    </div>
  </div>
);
