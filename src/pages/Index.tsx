...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 transition-all duration-300">
      <Navbar />
      ...
      <main className="relative">
        ...
        >
          ...
          <div className="bg-gray-200 dark:bg-gray-700 border-t border-gray-300 dark:border-gray-600 transition-colors duration-300">
          ...
          <div className="relative bg-gray-200 dark:bg-gray-700 border-t border-gray-300 dark:border-gray-600 transition-colors duration-300 overflow-hidden">
